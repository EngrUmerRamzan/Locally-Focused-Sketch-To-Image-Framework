...
from models.ImageSynthesis import FeedbackLoopModule, SelfSupervisedModule
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        for sketches, photos in tqdm(train_dataloader, desc=f'Epoch - {epoch+1} / {args.epochs}'):
            ...
            refined_image = feed_back_module(fake_photos)
            ...
            loss_G = loss_perceptual + 10 * loss_G_L1 + loss_G_BCE + refined_image_loss_weight * refined_image_loss + self_supervised_loss_weight * self_supervised_loss
